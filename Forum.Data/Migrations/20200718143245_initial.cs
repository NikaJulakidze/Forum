        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingPoints = table.Column<int>(nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                name: "UserRatingPoints",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RatingPoints = table.Column<int>(nullable: false),
                    AddedTime = table.Column<DateTime>(nullable: false, defaultValueSql: "getdate()"),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRatingPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserRatingPoints_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "getdate()"),
                    IsAcceptedAnswer = table.Column<bool>(nullable: false, defaultValue: false),
                    RatingPoints = table.Column<int>(nullable: false, defaultValue: 0),
                    UserId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagAnswers_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TagAnswers_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagAnswers_AnswerId",
                table: "TagAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_TagAnswers_QuestionId",
                table: "TagAnswers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_TagAnswers_TagId",
                table: "TagAnswers",
                column: "TagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRatingPoints_UserId",
                table: "UserRatingPoints",
                column: "UserId");
        }
